...
class EditProduct extends Component {
  ...
  componentDidMount(){
    ...
    axios.get('http://54.84.43.211:5000/products/finds/'+this.props.match.params.id)
    .then(response=>{
  ...
  {   let formdata = new FormData();
      ...
      axios.put('http://54.84.43.211:5000/products/update/'+this.props.match.params.id,formdata)
