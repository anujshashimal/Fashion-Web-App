...
class EditProduct extends Component {
  ...
  componentDidMount(){
    ...
    axios.get('http://167.172.155.186/products/finds/'+this.props.match.params.id)
    .then(response=>{
    ...
    axios.get('http://167.172.155.186/category/:id')
    .then(response=>{
  ...
  {   let formdata = new FormData();
      ...
      axios.put('http://167.172.155.186/products/update/'+this.props.match.params.id,formdata)
