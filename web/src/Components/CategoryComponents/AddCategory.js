...
export class Addcategory extends Component {
    ...
    componentDidUpdate() {
        axios.get('http://18.207.3.182:5000/category/findCategory/'+this.state.MainCategory+'/'+this.state.Admin)
            .then(response=>{
        ...
        if(this.state.CategoryName != "" ){
            if(this.state.MainCategory !=""){
                if(this.state.Admin != ""){
                    ...
                    axios.get('http://18.207.3.182:5000/category/findCategorybyname/'+this.state.MainCategory+'/'+this.state.CategoryName)
                        .then(response=> {
                            if (response.data.length == 0) {

                                axios.get('http://18.207.3.182:5000/categoryID/CategoryID')
                                    .then(response=>{
                                        if(response.data.length>0){
                                            this.setState({
                                        ...
                                        axios.post('http://18.207.3.182:5000/category/addCategory',Category)
                                        ...
                                        axios.post('http://18.207.3.182:5000/categoryID/updateCategoryID',CategoryID)
                                            .then(res=>console.log(res.data));
                                                                       ...
                                                                       swal({
                                                                           ...
                                                                           .then((willDelete) => {
                                                                               if (willDelete) {
                                                                                   ...
                                                                                   axios.delete('http://18.207.3.182:5000/category/deletecategory/'+SubCategoryNames.Category_ID)
                                                                                       .then(res=>console.log(res.data));
                                                                               } else {
