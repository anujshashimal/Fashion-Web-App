...
export class comments extends Component {
    ...
    componentDidUpdate(){
        axios.get('http://100.24.72.11:5000/Comments/find')
        .then(response=>{
    ...
    async sendData () {
        ...
        try{
            const responce = await axios({
                method: 'post',
                url: 'http://100.24.72.11:5000/Comments/add',
                data: data,
              });
    ...
    HandleUpdate = () => {
        ...
        axios.post('http://100.24.72.11:5000/Comments/update/'+this.state.editid,Comments)
       .then(res=>console.log(res.data));
       this.setState({
        editid: '',
        comment: null,
